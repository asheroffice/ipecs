...
<body class="home-page about-corporate-page">
    ...
    <section class="contact-hero about-page-hero">
    ...
    <section class="about-newsletter-section">
        <div class="container">
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-7">
                        <form class="about-newsletter-form" action="#" method="get">
                            <label class="visually-hidden" for="about-newsletter-email">Your email</label>
                            <div class="input-group about-newsletter-input-group">
                                <input name="email" type="email" class="form-control about-newsletter-input" id="about-newsletter-email" placeholder="Your email" autocomplete="email">
